...
object Constant {
    ...
    object ITEMS {
      ...
      object DESERT {
        object CACTUS {
          ...
          val IMAGE_SOURCE = "data/images/item/desert/Cactus"
        }

        object DESERTIC_ROCK {
          val RENDERING_FACTOR = 35
          val IMAGE_SOURCE = "data/images/item/desert/DeserticRock"
        }
  ...
  object RENDERING {
    object CAR {
      ...
      var INTERIOR_SCALE = 1.3f
      var INTERIOR_VERTICAL_ANCHOR = 0.2f
    }
  }
}
