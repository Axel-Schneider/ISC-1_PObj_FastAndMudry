...
Ce rapport présente d'abord l'architecture générale du projet, puis la génération de la route et de la carte, la machine à états qui gère le déroulement du jeu, la gestion de la musique et des sons, et enfin les défis qu'on a rencontré sur le rendu graphique, en particulier le passage au Mode 7 et l'affichage des objets.
