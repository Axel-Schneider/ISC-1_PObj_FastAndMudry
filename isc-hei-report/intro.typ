...
Ce rapport présente d'abord l'architecture générale du projet, puis la génération de la route et de la carte, la machine à états qui gère le déroulement du jeu, la gestion de la musique et des sons, le fonctionnement du rendu pseudo-3D avec le Mode 7 et l'affichage des objets, et enfin les défis qu'on a rencontré sur le rendu graphique.
